            ...
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    <div class="tab-container">
                        <div class="row">
                            <div class="row col-md-12"><h5>Email:</h5></div>
                            <div class="row">
                                <div class="col-md-12">
...
<!--                                </div>
                                <div class="col-md-10">-->
                                    <?php if (empty($_GET['account']) || $_GET['account'] !== "email") { ?>
                                        <button class="btn btn-xs btn-primary"  onclick='location.href = "?controller=member&action=account&account=email"'>Change Email</button>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row accountupdate"><form action="" method="POST" class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row col-md-12" >
                                                <input  class="form-control " id="email" type="email" name="email" placeholder="New Email" autofocus required/>
                                                <input type="submit" class="btn btn-xs btn-primary  submitbutton" value="Update" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
