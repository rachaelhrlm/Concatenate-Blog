...
<div class="tab-pane fade <?php echo (isset($_GET['target']) && $_GET['target'] == 'login') ? "active show" : ""; ?>" id="loginDetails" role="tabpanel" aria-labelledby="loginDetails-tab">
    <div class="tab-container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 text-center"><button class="btn btn-outline-secondary" onclick="showHide('email')">Change Email</button></div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 text-center"><button class="btn btn-outline-secondary" onclick="showHide('passwords')">Change Password</button></div>
        </div>
